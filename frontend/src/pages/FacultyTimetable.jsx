  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 p-4 md:p-6 print:p-0">
      ...
      <div className="relative z-10 max-w-7xl mx-auto print:max-w-none">
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1 print:text-sm">
                  Faculty ID: <span className="font-mono font-medium">{faculty?.id || faculty?._id?.substring(0, 8) || "N/A"}</span>
                </p>
              </div>
            </div>
          </div>
        ...
        {/* View Mode Toggle */}
        <div className="bg-white rounded-xl p-4 border border-gray-200 shadow-sm mb-6 print:hidden">
          <div className="flex items-center justify-between">
              ...
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="text-left py-3 px-6 text-sm font-medium text-gray-700">Subject/Sem</th>
                  </tr>
                </thead>
        ...
        {/* Legend and Notes */}
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6 border border-blue-100 print:hidden">
            ...
            <div>
              ...
              <ul className="space-y-2 text-blue-800 text-sm">
                ...
                <li className="flex items-center gap-2">
                  ...
                  <span><strong>Colored Cells</strong> - Different branches have different colors</span>
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-3 h-3 bg-purple-100 border border-purple-300 rounded-full"></div>
                  <span><strong>Class Format</strong> - Branch-Division-Semester (e.g., CSE-4-A)</span>
                </li>
              </ul>
            </div>
